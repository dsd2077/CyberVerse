export const baseMessages = {
  'zh-CN': {
    ...
    session: {
      ...
      connectionFailed: '连接会话失败，请返回角色列表后重新启动。',
    ...
    task: {
      defaultTitle: '后台任务',
      defaultArtifactTitle: '任务产物',
      listJoiner: '、',
      meta: 'task_id: {id} · {count} 个事件',
      timelineTitle: '执行过程',
      timelineEmpty: '等待任务事件...',
      artifactLabel: '产物',
      artifactPreviewHint: '可预览页面',
      artifactOpenHint: '可打开资料',
      preview: '预览',
      open: '打开',
      status: {
        queued: '排队中',
      ...
      event: {
        ...
        planDescription: '生成计划：{steps}',
        artifactDescription: '{type} 页面已写入 artifact',
        completedDescription: '任务已完成',
      },
      current: {
        completedWithArtifact: '已完成：资料已生成',
      },
    },
    controlBar: {
      connect: 'Connect',
  ...
  'en-US': {
    ...
    session: {
      ...
      connectionFailed: 'Failed to connect this session. Return to the character list and launch again.',
      frameJitter: 'Frame Jitter',
      meanInterval: 'Mean interval',
      stddev: 'Stddev',
      p95: 'P95',
    ...
    task: {
      defaultTitle: 'Background task',
      defaultArtifactTitle: 'Task artifact',
      listJoiner: ', ',
      meta: 'task_id: {id} · {count} events',
      timelineTitle: 'Execution',
      timelineEmpty: 'Waiting for task events...',
      artifactLabel: 'Artifact',
      artifactPreviewHint: 'Previewable page',
      artifactOpenHint: 'Openable material',
      preview: 'Preview',
      open: 'Open',
      status: {
        queued: 'Queued',
      ...
      event: {
        ...
        started: 'Started',
        planCreated: 'Planned',
        researchBlocked: 'Finding sources',
        ...
        planDescription: 'Plan created: {steps}',
        artifactDescription: '{type} page written to artifact',
        completedDescription: 'Task completed',
      },
      current: {
        completedWithArtifact: 'Completed: material generated',
      },
    },
    controlBar: {
      connect: 'Connect',
