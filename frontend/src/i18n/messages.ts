export const baseMessages = {
  'zh-CN': {
    ...
    characterEdit: {
      ...
      voiceLLMHelp: '端到端的语音大模型：语音识别、对话生成和语音合成由同一个 Voice LLM 服务完成。',
      voiceType: '声线类型',
      lineVoice: '声线',
      officialVoice: '官方音色',
      clonedVoice: '克隆音色',
    ...
    session: {
      ...
      clear: '清空',
      micInput: '麦克风输入',
      footerHint: 'Shift+Enter 换行 · VoiceLLM 模式下可直接语音对话',
  ...
  'en-US': {
    ...
    characterEdit: {
      ...
      voiceLLMHelp: 'End-to-end voice model mode: ASR, dialog generation, and speech synthesis are handled by one Voice LLM service.',
    ...
    session: {
      ...
      clear: 'Clear',
      micInput: 'Mic input',
      footerHint: 'Shift+Enter for newline · VoiceLLM mode supports direct voice conversation',
      frameJitter: 'Frame Jitter',
      meanInterval: 'Mean interval',
      stddev: 'Stddev',
      p95: 'P95',
